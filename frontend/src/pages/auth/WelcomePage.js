...
import CatLogo from "../../assets/icons/logo/Connectify.png";

const WelcomePage = () => {
  const SocialArray = [
    {
      bg: "#2b3137",
      link: "https://github.com/isumit22/",
      icon: <GithubLogo color="#fafbfc" weight="duotone" alt="github" />,
    },
    {
      bg: "radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f 60%,#285AEB 90%)",
      link: "https://www.instagram.com/sumitch_01/",
      icon: <InstagramLogo color="#fff" alt="instagram" />,
    },
    {
      bg: "#0A66C2",
      link: "https://www.linkedin.com/in/sumit-chaubey-33308a24b/",
    ...
    <Box widht={"100%"} sx={{ py: 4 }}>
      ...
      >
        <Box>
          ...
          >
            A robust web-based Real-Time Chat App developed by Sumit Chaubey.
          </Typography>
      ...
      <Box mt={10}>
        <Stack spacing={2}>
          ...
          <Typography variant="body1">
            Connectify is a real-time web-based chat application developed by
            Sumit Chaubey. Boasting not only a visually appealing UI but also
            packed with an array of enticing features, Connectify is designed
            ...
            system, Connectify ensures not just connectivity but a symphony of
